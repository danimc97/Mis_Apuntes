...
ALTER TABLE ciclista
  ADD CONSTRAINT Cl_1 FOREIGN KEY (nomeq) REFERENCES equipo(nomeq) ON DELETE RESTRICT ON UPDATE CASCADE;


ALTER TABLE puerto
  ADD CONSTRAINT Cl_2 FOREIGN KEY (netapa) REFERENCES etapa(netapa) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE puerto
  ADD CONSTRAINT Cl_3 FOREIGN KEY (dorsal) REFERENCES ciclista(dorsal) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE llevar
  ADD CONSTRAINT Cl_4 FOREIGN KEY (dorsal) REFERENCES ciclista(dorsal) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE llevar
  ADD CONSTRAINT Cl_5 FOREIGN KEY (netapa) REFERENCES etapa(netapa) ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE llevar
  ADD CONSTRAINT Cl_6 FOREIGN KEY (codigo) REFERENCES maillot(codigo) ON DELETE RESTRICT ON UPDATE CASCADE;


ALTER TABLE etapa
  ADD CONSTRAINT Cl_7 FOREIGN KEY (dorsal) REFERENCES ciclista(dorsal) ON DELETE RESTRICT ON UPDATE CASCADE;
